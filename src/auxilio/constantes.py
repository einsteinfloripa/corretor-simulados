...
class PS:
    ...
    required_fields = {
        "dados_alunos": ["aluno", "cpf"],
        "gabarito": [
            "numero",
            "resposta",
        ],
        "respostas": ["cpf", *[f"{x}" for x in range(1, n_questoes + 1)]],
    }
...
areas_ufsc = [
    {"Primeira Língua": ["Português/Literatura"]},
...
codigo_2lingua_dicionario = {
    "2Lingua": {
        "Inglês": {
            "Código": 0,
            "Posição": [
                posicao_linguas_na_planilha["Inglês"]["Início"],
        ...
        "Espanhol": {
            "Código": 1,
            "Posição": [
                posicao_linguas_na_planilha["Espanhol"]["Início"],
