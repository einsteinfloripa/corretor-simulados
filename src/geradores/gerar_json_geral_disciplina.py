from auxilio.constantes import codigo_2lingua_dicionario as c2l, areas_enem, areas_ufsc
...
def calcular_general_porcent_ufsc(subjects):
    for area_ufsc in areas_ufsc:
        for chave_dicionario, disciplinas_area in area_ufsc.items():
            for disciplina in disciplinas_area:
                subjects[chave_dicionario][disciplina]["general_percent"] = round(
                    subjects[chave_dicionario][disciplina]["general_percent"] /
